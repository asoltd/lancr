...
func RegisterApprenticeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ApprenticeServiceServer) error {
	...
	mux.Handle("PUT", pattern_ApprenticeService_UpdateApprentice_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/lancr.v1.ApprenticeService/UpdateApprentice", runtime.WithHTTPPathPattern("/v1/apprentices/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterApprenticeServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ApprenticeServiceClient) error {
	...
	mux.Handle("PUT", pattern_ApprenticeService_UpdateApprentice_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/lancr.v1.ApprenticeService/UpdateApprentice", runtime.WithHTTPPathPattern("/v1/apprentices/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_ApprenticeService_UpdateApprentice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "apprentices", "id"}, ""))
