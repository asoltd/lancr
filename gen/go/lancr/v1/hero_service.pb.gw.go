...
func RegisterHeroServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HeroServiceServer) error {
	...
	mux.Handle("PUT", pattern_HeroService_UpdateHero_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/lancr.v1.HeroService/UpdateHero", runtime.WithHTTPPathPattern("/v1/heroes"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterHeroServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HeroServiceClient) error {
	...
	mux.Handle("PUT", pattern_HeroService_UpdateHero_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/lancr.v1.HeroService/UpdateHero", runtime.WithHTTPPathPattern("/v1/heroes"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_HeroService_UpdateHero_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "heroes"}, ""))
